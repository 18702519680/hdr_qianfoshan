...
public class PropertiesUtilsTOCDA extends PropertiesUtils {
	...
	public static void addPropertyValue(String fileName, String propName, String value) {
		try {
			...
			File file = new File(PropertiesUtils.class.getResource("/" + fileName).getPath());
	...
	public static void main(String args[]) {
		PropertiesUtils.addPropertyValue("test.properties", "hello", "world");
		String value = PropertiesUtils.getPropertyValue("test.properties", "hello");
