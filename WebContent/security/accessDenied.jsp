...
<body>
没有权限，拒绝访问。
<span id="jumpTo">5</span>秒后自动 <a href="<%=request.getContextPath()%>/hsdq/j_spring_security_logout">跳转至登陆页</a>
<script type="text/javascript">countDown(5,"<%=request.getContextPath()%>/hsdq/j_spring_security_logout");</script>  
</body>
</html>