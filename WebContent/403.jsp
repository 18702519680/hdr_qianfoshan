...
.content{
	width:570px;
	height:290px;
	background:url("<%=request.getContextPath()%>/console/default/images/403.png") -63px  no-repeat;
	margin:0 auto;
	margin-top:47px;
	padding-left:367px;
	position:relative;
...
<div id="main">
	 ...
	 <div class="button">
	 	<button class="up" style="margin-right:198px;">返回上一页</button>
